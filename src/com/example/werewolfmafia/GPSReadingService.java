...
public class GPSReadingService extends Service implements LocationListener {
	...
	public GPSReadingService(Context context) {
	...
	void getPrefs(){
		...
		Log.d("GPSGet Perfs", semail+"|"+sname+"|"+spassword_digest+"|"+sremember_token+"|"+String.valueOf(suser_id)+"|"+String.valueOf(sgame_id)+"|"+String.valueOf(splayer_id)+"|");
		this.s1=semail;
		this.s2=sname;
					...
					if (location == null) {
						...
						if (locationManager != null) {
							...
							if (location != null) {
								...
								longitude = location.getLongitude();
								getPrefs();
								Log.d("GPSsend Perfs", this.s1+"|"+this.s2+"|"+this.s3+"|"+this.s4+"|"+String.valueOf(this.s5)+"|"+String.valueOf(this.s6)+"|"+String.valueOf(this.s7)+"|");
	...
	public void stopUsingGPS() {
		if (locationManager != null) {
			locationManager.removeUpdates(GPSReadingService.this);
		}
	}
